...
import AddUpdateProduct from '../views/products/AddUpdateProduct'
...
const ProtectedProductsIndex = Layout(ProductsIndex);
const ProtectedAddUpdateProduct = Layout(AddUpdateProduct);
